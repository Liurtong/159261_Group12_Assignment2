...
public abstract class GameEngine implements KeyListener, MouseListener, MouseMotionListener {
    ...
    ImageIcon logo = new ImageIcon("picture/logo.png");
    ...
    public void setupWindow(int width, int height) {
        ...
        mWidth = width;
        mHeight = height;
        mFrame.setIconImage(logo.getImage().getScaledInstance(logo.getIconWidth(),logo.getIconHeight(),Image.SCALE_DEFAULT));

        mFrame.setSize(width, height);
        mFrame.setLocation(500,100);
        mFrame.setTitle("Taps");
    ...
    //新加的setVisible(false)
    public void falseToSee(Image image){
